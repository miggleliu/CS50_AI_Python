...
class NimAI():
    ...
    def choose_action(self, state, epsilon=True):
        ...
        # else epsilon is True
        is_randomstate = random.choices(population=[False,True], weights=[1-self.epsilon, self.epsilon])[0]
        if not is_randomstate:
            return best_action
            
        # else is_randomstate is True
